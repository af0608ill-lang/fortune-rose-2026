...
def game_clear():
    ...
    # To be deterministic with ties, maybe sort keys?
    # Counter.most_common maintains insertion order for ties, so first encountered dominant wins.
    ...
    # Keys: (first, last, most) where values are 'red', 'yellow', 'purple'
    ...
    # Fallback for keys not in dict (just in case)
